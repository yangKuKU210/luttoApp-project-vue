  ...
  export default {
    ...
    data() {
      return {
        ...
        Bol:1,
        imgUrl:require("../../assets/good_details/dianzan.svg"),
        imgUrl2:require('../../assets/good_details/dianzan-red.svg')
      }
    },
    created: function () {
      ...
      add_cart:function (e) {
        ...
        axios({
          ...
          if(code=="206"){
            ...
            // vm.motai_data = "加入成功"
            // vm1('.modal-content').css({"margin-left":"660px"})
            // vm1('#myModalDesc').modal('show');
            // setTimeout(function(){
            //   vm1("#myModalDesc").modal("hide")
            // },800);
          }else if(code == "411"){
